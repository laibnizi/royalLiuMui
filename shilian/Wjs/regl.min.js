(function(da, ea) {
	...
	function cb(a, b, c, d, f) {
		...
		if(4 === b.length - c) {
			...
			for(p = 0; p < h; ++p) cb(a[p], b, c + 1, d, f), f += k
	}
			...
			if(Array.isArray(b)) {
				if(a.dtype = d || 5126, 0 < b.length)
					if(Array.isArray(b[0])) {
						...
						n ? a.persistentData = b : x.freeType(b))
			} else if(O(b)) a.dtype = d || Ha(b), a.dimension = e, f(a, b, c), n && (a.persistentData = new Uint8Array(new Uint8Array(b.buffer)));
			else if(ja(b)) {
				e = b.shape;
				var g = b.stride,
					D = b.offset,
	...
	function Cb(a, b, c, d) {
		...
		return {
			create: function(a, b) {
				function g(a) {
					if(a)
						if("number" === typeof a) e(a), n.primType = 4, n.vertCount = a | 0, n.type = 5121;
						else {
							var b = null,
								c = 35044,
								d = -1,
							...
							if(Array.isArray(a) || O(a) || ja(a)) b =
								a;
							else if("data" in a && (b = a.data), "usage" in a && (c = hb[a.usage]), "primitive" in a && (d = Ra[a.primitive]), "count" in a && (f = a.count | 0), "type" in a && (p = r[a.type]), "length" in a) l = a.length | 0;
	...
	function Fb(a, b, c, d, f, k, p) {
		...
		function u(a, b) {
			...
			if(b.copy) {
				...
				a.channels || 4;
			else if(O(c)) a.channels = a.channels || 4, a.data = c, "type" in b || 5121 !== a.type || (a.type = Ea[Object.prototype.toString.call(c)] | 0);
			else if(kb(c)) {
				...
				for(var K = x.allocType(36193 === a.type ? 5126 : a.type, q * y * l), aa = 0, va = 0; va < y; ++va)
					for(var wa = 0; wa < q; ++wa)
						for(var ca = 0; ca < l; ++ca) K[aa++] = g[e * wa + d * va + n * ca + c];
				mb(a, K)
				...
				a.width = a.element.width, a.height = a.element.height, a.channels = 4;
			else if("[object HTMLImageElement]" === oa(c)) a.element = c, a.width = c.naturalWidth, a.height = c.naturalHeight, a.channels = 4;
			else if("[object HTMLVideoElement]" === oa(c)) a.element = c, a.width = c.videoWidth, a.height = c.videoHeight, a.channels = 4;
			else if(lb(c)) {
		...
		function t(a, b) {
			...
			if(Sa(b)) c = a.images[0] = e(), g(c, a), u(c, b), a.mipmask = 1;
				...
				for(var d = b.mipmap, f = 0; f < d.length; ++f) c = a.images[f] = e(), g(c, a), c.width >>= f, c.height >>= f, u(c, d[f]), a.mipmask |= 1 << f;
			else c = a.images[0] = e(), g(c, a), u(c,
				b), a.mipmask = 1;
			g(a, a.images[0])
		}
			...
			createCube: function(b, c, d, f, l, sa) {
				function z(a, b, c, e, d, f) {
					...
					if("number" === typeof a || !a)
						...
						if(b) t(q[0], a), t(q[1], b), t(q[2], c), t(q[3], e), t(q[4], d), t(q[5], f);
						else if(M(X, a), r(h, a), "faces" in a)
						for(a = a.faces, F = 0; 6 > F; ++F) g(q[F], h), t(q[F], a[F]);
					else
						for(F = 0; 6 > F; ++F) t(q[F], a);
					g(h, q[0]);
				...
				z.resize = function(b) {
					...
					if(b !== h.width) {
						...
						Q(h);
						for(var c = 0; 6 > c; ++c)
							for(var q = 0; h.mipmask >> q; ++q) a.texImage2D(34069 + c, q, h.format, b >> q,
					...
					for(var c = 0; 32 > c; ++c)
						if(0 !== (b.mipmask & 1 << c))
							if(3553 === b.target) a.texImage2D(3553, c, b.internalformat, b.width >> c, b.height >> c, 0, b.internalformat, b.type, null);
								...
								for(var e = 0; 6 > e; ++e) a.texImage2D(34069 + e, c, b.internalformat, b.width >> c, b.height >> c, 0, b.internalformat, b.type, null);
		...
		function t(a, b) {
			function c(a, b) {
				...
				if(Array.isArray(e)) G = e.map(v);
					...
					for(G = Array(D), e = 0; e < D; ++e) G[e] = l(f, h, p, t, r);
				f = f || G[0].width;
				h = h || G[0].height;
		...
		return A(Z, {
			...
			createCube: function(a) {
				function b(a) {
					...
					for(e = 0; e < a.length; ++e) n = a[e], f = f || n.width, g.color[e] = {
						target: 34069,
						data: a[e]
					};
					for(e = 0; 6 > e; ++e) {
	...
	function Ob(a, b, c, d, f, k, p, h, g, r, v, l, u, m, e) {
		...
		function C(a) {
			...
			ta(d) && ta(g) ? (ca = v.program(g.id, d.id), a = B(function(a, b) {
				...
				g && g.thisDep, d && d.contextDep || g && g.contextDep, d && d.propDep || g && g.propDep,
				function(a, b) {
			...
			return {
				...
				count: function() {
					...
					return d ? ta(d) ? d ? g ? new Y(g.thisDep, g.contextDep, g.propDep, function(a, b) {
						...
						g.contextDep, d.propDep || g.propDep,
						function(a, b) {
							var c = a.ELEMENTS;
		...
		function Q(a, c) {
			...
			Object.keys(e).forEach(function(a) {
				var c = e[a],
					...
					q = new xa;
				if(Na(c)) q.state = 1,
					q.buffer = f.getBuffer(f.create(c, 34962, !1, !0)), q.type = 0;
				else {
					var y = f.getBuffer(c);
		...
		function U(a, c, e, d, f) {
			for(var g = a.shared, l = g.gl, h, k = 0; k < d.length; ++k) {
				...
				if(t) {
					...
					if(ta(t)) {
						n = t.value;
						if(35678 === p || 35680 === p) p = a.link(n._texture || n.color[0]._texture), c(l, ".uniform1i(", m, ",", p + ".bind());"), c.exit(p, ".unbind();");
						else if(35674 === p || 35675 === p || 35676 === p) n = a.global.def("new Float32Array([" + Array.prototype.slice.call(n) + "])"), t = 2, 35675 === p ? t = 3 : 35676 ===
							p && (t = 4), c(l, ".uniformMatrix", t, "fv(", m, ",false,", n, ");");
						else {
							switch(p) {
								case 5126:
									h = "1f";
		...
		function ha(a, b) {
			...
			else if(f = f.append(a, e), e(a.shared.gl,
					".useProgram(", f, ".program);"), b.shader.program) ya(a, e, b, b.shader.program);
			else {
				var g = a.global.def("{}"),
					h = e.def(f, ".id"),
					l = e.def(g, "[", h, "]");
		...
		function fa(a, b, c) {
			...
			if(d && ja(d)) {
				...
				g.forEach(function(b) {
					var c = d[b];
					if(ia.isDynamic(c)) "function" === typeof c && (c = d[b] = ia.unbox(c)), b = N(c, null), h = h || b.thisDep, m = m || b.propDep, l = l || b.contextDep;
					else {
						f(k, ".", b, "=");
						switch(typeof c) {
							case "number":
	...
	var A = function(a, b) {
		...
		La = {
			...
			flatten: function(a, b, c, d) {
				var f = 1;
				if(b.length)
					for(var k = 0; k < b.length; ++k) f *= b[k];
				else f = 0;
				c = d || x.allocType(c, f);
				switch(b.length) {
					case 0:
	...
	return function(a) {
		...
		function p(a) {
			...
			return A(function(a, b) {
				...
				if("function" === typeof b)
					...
					for(d = 0; d < a.length; ++d) l.call(this,
						a[d], b, d);
		...
		e = A(p, {
			clear: function(a) {
				if("framebuffer" in a)
					if(a.framebuffer && "framebufferCube" ===
						a.framebuffer_reglType)
						for(var b = 0; 6 > b; ++b) Y(A({
